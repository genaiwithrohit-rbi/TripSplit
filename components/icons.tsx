...
export const UsersIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.663M12 12a4.5 4.5 0 004.5-4.5m-4.5 4.5a4.5 4.5 0 01-4.5-4.5M12 12v9" />
  </svg>
);
...
export const ShareIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.042.586.042h4.4c.196 0 .391-.017.586-.042m-5.572 0a2.25 2.25 0 012.25-2.25h1.121a2.25 2.25 0 012.25 2.25m-5.572 0l-1.121 1.092a2.25 2.25 0 001.121 3.858h1.121a2.25 2.25 0 001.121-3.858m-5.572 0a2.25 2.25 0 00-2.25 2.25v1.121a2.25 2.25 0 002.25 2.25m5.572 0h-1.121a2.25 2.25 0 00-2.25 2.25v1.121a2.25 2.25 0 002.25 2.25m5.572 0l1.121-1.092a2.25 2.25 0 01-1.121-3.858h-1.121a2.25 2.25 0 01-1.121 3.858m0 0v-1.121a2.25 2.25 0 012.25-2.25h1.121a2.25 2.25 0 012.25 2.25m-2.25-5.636a2.25 2.25 0 00-2.25-2.25H9.521a2.25 2.25 0 00-2.25 2.25" />
    </svg>
);
